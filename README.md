...
- **街机厅**（arcade）— 文字街机厅：老虎机、21 点、轮盘 — 多肉饲养员 · [GitHub](https://github.com/reneyuxi0402/claude-arcade)
- **午间汉堡铺**（burger）— 命令行汉堡店经营 — 飞鸢 · [GitHub](https://github.com/linzhi-524/noon-burger-shop)
- **坩埚余响**（crucible_echoes）— 确定性文字炼金构筑 Roguelike — athok · [GitHub](https://github.com/megabaka404/crucible-echoes)
- **植物大战丧尸随机版**（imitator_td）— 随机塔防 — すみか · [GitHub](https://github.com/wxynora/random-imitator-td)
- **Memoria Station**（memoria）— 五关文字推理车站谜案 — 雨刀 · [GitHub](https://github.com/hatakeyuyuko-dotcom/Memoria-Station)
